...
const Services = ({ isDarkMode }) => {
  return (
    ...
    >
      ...
      >
        I provide a wide range of services, including web development, mobile
        app development, machine learning solutions, custom software creation,
        and assessment projects. My goal is to deliver high-quality, tailored
      ...
      >
        {serviceData.map(({ icon, title, description, link }, index) => (
          ...
          >
            ...
            <p className="text-sm text-gray-700 leading-5 dark:text-white">
              {description}{" "}
            </p>
            <p>
